<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"D:\lp\WWW\jingguan\public/../application/index\view\neiye\zysz.html";i:1547193185;s:70:"D:\lp\WWW\jingguan\public/../application/index\view\public\footer.html";i:1547171540;}*/ ?>
  ...
  <div class="nav-wrapper">
    ...
    <div class="nav" id="nav">
      <ul class="nav_lf">
          ...
          <li><a class="bxyact" href="<?php echo url('neiye/zysz'); ?>">专业建设与人才培养</a></li>
...
<div class="container">
    <div class="row">
        <div class="col-md-3  wow fadeInLeft" data-wow-delay="0.2s">
          <dl class="bxye">
           <dt>专业建设与人才培养</dt>
           <dd class="curr"><a href="<?php echo url('neiye/zysz'); ?>">专业设置</a></dd>
           <dd><a href="<?php echo url('neiye/zyjs'); ?>">专业建设</a></dd>
           <dd><a href="<?php echo url('neiye/rcpy'); ?>">人才培养目标与方案</a></dd>
          </dl>
        </div>
        <div class="col-md-9  wow fadeInRight" data-wow-delay="0.2s">
         <div class="bxyf"><i>专业设置</i><ul><li>您当前的位置：</li><li><a href="<?php echo url('neiye/index2'); ?>">首页</a></li><li>>></li><li><a href="">专业建设与人才培养</a></li><li>>></li><li><a href="">专业设置</a></li></ul></div>
         <div class="bxyg">
            <div class="zyjsbox" style="height:500px;">
           		<!--<img src="__STATIC__/images/bxyg.jpg" class="img-responsive" style="margin:0 auto;">-->
