<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:57:"D:\lp\WWW\jingguan/application/index\view\neiye\dwjg.html";i:1547284749;s:60:"D:\lp\WWW\jingguan/application/index\view\public\footer.html";i:1547171540;}*/ ?>
  ...
  <div class="nav-wrapper">
    ...
    <div class="nav" id="nav">
      <ul class="nav_lf">
          ...
          <li><a class="bxyact" href="<?php echo url('neiye/dwjg'); ?>">师资结构与素质</a></li>
    ...
    <div class="row">
        <div class="col-md-3  wow fadeInLeft" data-wow-delay="0.2s">
          <dl class="hidden-xs bxye">
           <dt class="xiala-title">师资结构与素质</dt>
           <dd class="curr"><a href="<?php echo url('neiye/dwjg'); ?>">队伍结构</a></dd>
           <dd><a href="<?php echo url('neiye/jgky'); ?>">教改科研</a></dd>
          </dl>
            <div class="hidden-sm hidden-md hidden-lg xiala-box panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#accordion"
                           href="#collapseOne">师资结构与素质<i class="glyphicon glyphicon-chevron-down"></i></a>
                    </h4>
                </div>
                <div id="collapseOne" class="panel-collapse collapse">
                    <div class="panel-body">
                        <ul>
                            <li class="curr"><a href="<?php echo url('neiye/dwjg'); ?>">队伍结构</a></li>
                            <li><a href="<?php echo url('neiye/jgky'); ?>">教改科研</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-9  wow fadeInRight" data-wow-delay="0.2s">
         <div class="bxyf"><i>队伍结构</i><ul><li>您当前的位置：</li><li><a href="index2.html">首页</a></li><li>>></li><li><a href="">师资结构与素质</a></li><li>>></li><li><a href="">队伍结构</a></li></ul></div>
         <div class="bxyg">
            <div class="zyjsbox" style="height:500px;"><?php echo $about['editorValue']; ?> </div>
         </div>
        </div>
    </div>
</div>
