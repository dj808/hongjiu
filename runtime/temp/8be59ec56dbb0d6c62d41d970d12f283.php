<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"D:\lp\WWW\jingguan\public/../application/index\view\tiaojian\bxnl.html";i:1547193196;s:70:"D:\lp\WWW\jingguan\public/../application/index\view\public\footer.html";i:1547171540;}*/ ?>
...
<div class="container">
    <div class="row">
        <div class="col-md-3  wow fadeInLeft" data-wow-delay="0.2s">
          <dl class="bxye">
           <dt>申报条件</dt>
           <dd class="curr"><a href="<?php echo url('tiaojian/bxnl'); ?>">办学理念</a></dd>
			 ...
			 <dd><a href="<?php echo url('tiaojian/szdw'); ?>">师资队伍</a></dd>
			  <dd><a href="<?php echo url('tiaojian/sjjx'); ?>">实践教学</a></dd>
			   <dd><a href="<?php echo url('tiaojian/bxbz'); ?>">办学保障</a></dd>
			    <dd><a href="<?php echo url('tiaojian/xszl'); ?>">学生质量</a></dd>
		   
		 
          </dl>
        </div>
        <div class="col-md-9  wow fadeInRight" data-wow-delay="0.2s">
         <div class="bxyf"><i>专业设置</i><ul><li>您当前的位置：</li><li><a href="index2.html">首页</a></li><li>>></li><li><a href="">申报条件</a></li><li>>></li><li><a href="">办学理念</a></li></ul></div>
         <div class="bxyg">
            <div class="zyjsbox">
           		开创多元化分类培养模式，根据学生发展潜力和个人选择，分为应用型、复合型和研究型三种类型分类培养，进行“菜单式”教学，同时积极鼓励学生参加国家法律考试、研究生考试，为职业规划打好基础。根据社会对安全保卫人才需求的新情况，本专业积极引导学生选修法学、警察体育与技能训练、证据学、刑事科学技术等相关课程，以适应用人单位对人才培养的要求。
               <br>
			   <br>
			   <br>
			   <br>
