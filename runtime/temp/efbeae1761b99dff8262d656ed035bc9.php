<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:57:"D:\lp\WWW\jingguan/application/index\view\neiye\zzcl.html";i:1547286161;s:60:"D:\lp\WWW\jingguan/application/index\view\public\footer.html";i:1547171540;}*/ ?>
            ...
            <div class="hidden-sm hidden-md hidden-lg xiala-box panel panel-default">
                ...
                <div id="collapseOne" class="panel-collapse collapse">
                    <div class="panel-body">
                        <ul>
                            <li ><a href="<?php echo url('neiye/sqs'); ?>">申请书</a></li>
                            <li class="curr"><a href="<?php echo url('neiye/zzcl'); ?>">佐证材料</a></li>
                        </ul>
                    </div>
                </div>
            </div>
