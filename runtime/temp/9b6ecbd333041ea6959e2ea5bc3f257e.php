<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:57:"D:\lp\WWW\jingguan/application/index\view\neiye\kcsj.html";i:1547285044;s:60:"D:\lp\WWW\jingguan/application/index\view\public\footer.html";i:1547171540;}*/ ?>
    ...
    <div class="row">
        <div class="col-md-3  wow fadeInLeft" data-wow-delay="1s">
          <dl class="hidden-xs bxye">
           <dt>课程建设与改革</dt>
           <dd class="curr"><a href="<?php echo url('neiye/kcsj'); ?>">课程设计</a></dd>
           <dd><a href="<?php echo url('neiye/kcss'); ?>">课程实施</a></dd>
                ...
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#accordion"
                           href="#collapseOne">课程建设与改革<i class="glyphicon glyphicon-chevron-down"></i></a>
                    </h4>
                </div>
                <div id="collapseOne" class="panel-collapse collapse">
                    <div class="panel-body">
                        <ul>
                            <li class="cur"><a href="<?php echo url('neiye/kcsj'); ?>">课程设计</a></li>
                            <li><a href="<?php echo url('neiye/kcss'); ?>">课程实施</a></li>
                            <li><a href="<?php echo url('neiye/kcgg'); ?>">课程改革</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-9  wow fadeInRight" data-wow-delay="1s">
         <div class="bxyf"><i>课程设计</i><ul><li>您当前的位置：</li><li><a href="<?php echo url('neiye/index'); ?>">首页</a></li><li>>></li><li><a href="">课程建设与改革</a></li><li>>></li><li><a href="">课程设计</a></li></ul></div>
         <div class="bxyg">
            <div class="zyjsbox" style="height:708px;">
           		<!--<img src="__STATIC__/images/1.jpg" class="img-responsive" style="margin:0 auto;">-->
