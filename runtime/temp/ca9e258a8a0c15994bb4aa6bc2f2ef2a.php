<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:59:"D:\lp\WWW\jingguan/application/index\view\index\index2.html";i:1547255227;s:60:"D:\lp\WWW\jingguan/application/index\view\public\footer.html";i:1547171540;}*/ ?>
...
<div class="swiper-container">
    <div class="swiper-wrapper">
        ...
        <div class="swiper-slide"><img src="__IMG__/<?php echo $vo['logo']; ?>"></div>
...
<div class="bxyi">
    <div class="container">
        <div class="row">
            <div class="col-md-5 col-xs-12 wow fadeInLeft"  data-wow-delay="0.2s"><img src="__IMG__/<?php echo $zyjs['img']; ?>" class="img-responsive"></div>
...
<div class="bxyk">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-5 col-xs-12  wow fadeInRight" data-wow-delay="0.2s"><img src="__IMG__/<?php echo $zyfzr['img']; ?>" class="img-responsive"></div>
        </div>
    </div>
</div>
...
<div class="bxylpc">
    ...
    <div class="container  wow fadeInUp" data-wow-delay="0.2s" >
        <div class="slider autoplay1 bxyx">
            ...
            <div><a href="javascript:;"><img src="__IMG__/<?php echo $vo['img']; ?>"><p><span><?php echo $vo['name']; ?></span><?php echo $vo['job']; ?></p></a></div>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </div>
    </div>
</div>
...
<div class="bxyy">
    <div class="container  wow fadeInUp " data-wow-delay="0.2s">
        <div class="row">
            ...
            <div class="col-md-6 col-xs-12 bxyyyy"><a href=""><img src="__IMG__/<?php echo $vo['img']; ?>" class="img-responsive bxyyy2"><div class="bxyya"><span>公共安全管理</span><p><?php echo $vo['intro']; ?></p><img src="__STATIC__/images/bxyy3.png"  class="img-responsive bxyy1"></div></a></div>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </div>
    </div>
</div>
...
<div class="bxyzpc">
    ...
    <div class="container  wow fadeInDown" data-wow-delay="0.2s" >
        <div class="slider autoplay2 bxyzpc2">
            ...
            <div><a href="javascript:;"><img src="__IMG__/<?php echo $vo['img']; ?>"></a><p><a href="javascript:;" title="<?php echo $vo['name']; ?>"><?php echo $vo['name']; ?></a></p></div>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </div>
    </div>
</div>
