<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:57:"D:\lp\WWW\jingguan/application/index\view\neiye\zljk.html";i:1547285200;s:60:"D:\lp\WWW\jingguan/application/index\view\public\footer.html";i:1547171540;}*/ ?>
  ...
  <div class="nav-wrapper">
    ...
    <div class="nav" id="nav">
      ...
      <ul class="nav_rt">
          ...
          <li><a  class="bxyact" href="<?php echo url('neiye/zljk'); ?>">教育质量与服务能力</a></li>
    ...
    <div class="row">
        <div class="col-md-3  wow fadeInLeft" data-wow-delay="0.2s">
          <dl class="hidden-xs bxye">
           <dt>教育质量与服务能力</dt>
           <dd class="curr"><a href="<?php echo url('neiye/zljk'); ?>">质量监控</a></dd>
           <dd><a href="<?php echo url('neiye/zlxy'); ?>">质量信誉</a></dd>
		   <dd><a href="<?php echo url('neiye/zlxsd'); ?>">质量显示度</a></dd>
		    <dd><a href="<?php echo url('neiye/fwnl'); ?>">服务能力</a></dd>
          </dl>
            <div class="hidden-sm hidden-md hidden-lg xiala-box panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#accordion"
                           href="#collapseOne">教育质量与服务能力<i class="glyphicon glyphicon-chevron-down"></i></a>
                    </h4>
                </div>
                <div id="collapseOne" class="panel-collapse collapse">
                    <div class="panel-body">
                        <ul>
                            <li class="cur"><a href="<?php echo url('neiye/zljk'); ?>">质量监控</a></li>
                            <li><a href="<?php echo url('neiye/zlxy'); ?>">质量信誉</a></li>
                            <li><a href="<?php echo url('neiye/zlxsd'); ?>">质量显示度</a></li>
                            <li><a href="<?php echo url('neiye/fwnl'); ?>">服务能力</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-9  wow fadeInRight" data-wow-delay="0.2s">
         <div class="bxyf"><i>质量监控</i><ul><li>您当前的位置：</li><li><a href="<?php echo url('neiye/index'); ?>">首页</a></li><li>>></li><li><a href="">教育质量与服务能力</a></li><li>>></li><li><a href="">质量监控</a></li></ul></div>
         <div class="bxyg">
