<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"D:\lp\WWW\tpAdmin\public/../application/admin\view\partner\edit.html";i:1546844630;s:69:"D:\lp\WWW\tpAdmin\public/../application/admin\view\template\base.html";i:1488899632;s:80:"D:\lp\WWW\tpAdmin\public/../application/admin\view\template\javascript_vars.html";i:1488899632;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    <form class="form form-horizontal" id="form" method="post" action="<?php echo \think\Request::instance()->baseUrl(); ?>">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" class="input-text" placeholder="合作伙伴名称" name="name" value="<?php echo isset($list['name']) ? $list['name'] :  ''; ?>"  datatype="*" nullmsg="请填写合作伙伴名称" errormsg="名称不能为空">
            </div>
