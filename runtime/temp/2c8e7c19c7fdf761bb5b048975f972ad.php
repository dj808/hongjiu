<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"D:\lp\WWW\jingguan\public/../application/index\view\neiye\fwnl.html";i:1547192925;s:70:"D:\lp\WWW\jingguan\public/../application/index\view\public\footer.html";i:1547171540;}*/ ?>
...
<section>
    <img src="images/neiye.jpg" class="img-responsive">
</section>
        ...
        <div class="col-md-3  wow fadeInLeft" data-wow-delay="0.2s">
          <dl class="bxye">
		   ...
		   <dd><a href="<?php echo url('neiye/zlxsd'); ?>">质量显示度</a></dd>
		    <dd class="curr"><a href="<?php echo url('neiye/fwnl'); ?>">服务能力</a></dd>
		   
          </dl>
        </div>
        <div class="col-md-9  wow fadeInRight" data-wow-delay="0.2s">
         <div class="bxyf"><i>专业设置</i><ul><li>您当前的位置：</li><li><a href="<?php echo url('neiye/index2'); ?>">首页</a></li><li>>></li><li><a href="">教育质量与服务能力</a></li><li>>></li><li><a href="">服务能力</a></li></ul></div>
         <div class="bxyg">
