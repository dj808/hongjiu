<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"D:\lp\WWW\jingguan\public/../application/index\view\neiye\jfbz.html";i:1547192934;s:70:"D:\lp\WWW\jingguan\public/../application/index\view\public\footer.html";i:1547171540;}*/ ?>
...
<div class="container">
    <div class="row">
        <div class="col-md-3  wow fadeInLeft" data-wow-delay="0.2s">
          <dl class="bxye">
           <dt>教学条件与投入</dt>
           <dd><a href="<?php echo url('neiye/jxzy'); ?>">教学资源</a></dd>
           <dd class="curr"><a href="<?php echo url('neiye/jfbz'); ?>">经费保障</a></dd>
          </dl>
        </div>
        <div class="col-md-9  wow fadeInRight" data-wow-delay="0.2s">
         <div class="bxyf"><i>专业设置</i><ul><li>您当前的位置：</li><li><a href="index2.html">首页</a></li><li>>></li><li><a href="">教学条件与投入</a></li><li>>></li><li><a href="">经费保障</a></li></ul></div>
         <div class="bxyg">
