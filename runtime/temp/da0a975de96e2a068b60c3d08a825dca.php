<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"D:\lp\WWW\jingguan\public/../application/index\view\neiye\zyys.html";i:1547192992;s:70:"D:\lp\WWW\jingguan\public/../application/index\view\public\footer.html";i:1547171540;}*/ ?>
...
<div class="container">
    <div class="row">
        <div class="col-md-3  wow fadeInLeft" data-wow-delay="0.2s">
          <dl class="bxye">
           <dt>教学管理与优势特色</dt>
           <dd><a href="<?php echo url('neiye/jxgl'); ?>">教学管理</a></dd>
           <dd  class="curr"><a href="<?php echo url('neiye/zyys'); ?>">专业优势与特色</a></dd>
		 
          </dl>
        </div>
        <div class="col-md-9  wow fadeInRight" data-wow-delay="0.2s" >
         <div class="bxyf"><i>专业设置</i><ul><li>您当前的位置：</li><li><a href="<?php echo url('neiye/index2'); ?>">首页</a></li><li>>></li><li><a href="">教学管理与优势特色</a></li><li>>></li><li><a href="">专业优势与特色</a></li></ul></div>
         <div class="bxyg">
