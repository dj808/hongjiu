<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"D:\lp\WWW\jingguan\public/../application/admin\view\kcgg\index.html";i:1547105798;s:70:"D:\lp\WWW\jingguan\public/../application/admin\view\template\base.html";i:1547105797;s:81:"D:\lp\WWW\jingguan\public/../application/admin\view\template\javascript_vars.html";i:1547105797;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    ...
    <form class="form form-horizontal" id="form" method="post" enctype="multipart/form-data"
          action="<?php echo Url('admin/kcgg/edit','',''); ?>">
        <input type="hidden" name="id" value="<?php echo isset($list['id']) ? $list['id'] :  ''; ?>">
        <?php else: ?>
    <form class="form form-horizontal" id="form" method="post" action="<?php echo Url('admin/kcgg/add','',''); ?>">
        <?php endif; ?>
