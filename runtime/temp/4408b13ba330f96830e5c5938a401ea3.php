<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"D:\lp\WWW\jingguan\public/../application/index\view\tiaojian\xszl.html";i:1547187644;s:70:"D:\lp\WWW\jingguan\public/../application/index\view\public\footer.html";i:1547171540;}*/ ?>
...
<header class="header">
  ...
  <div class="nav-wrapper">
    <div class="logo"><a href="{:Url('index/index2')}"><img src="__STATIC__/images/logo.png" alt="" style="width:100%;max-width:100%;width:auto\9;-ms-interpolation-mode: bicubic;"></a></div>
...
<div class="container">
    <div class="row">
        <div class="col-md-3  wow fadeInLeft" data-wow-delay="0.2s">
          <dl class="bxye">
           <dt>申报条件</dt>
              <dd ><a href="<?php echo url('tiaojian/bxnl'); ?>">办学理念</a></dd>
              <dd ><a href="<?php echo url('tiaojian/pyms'); ?>">培养模式</a></dd>
              <dd ><a href="<?php echo url('tiaojian/jxff'); ?>">教学方法</a></dd>
              <dd ><a href="<?php echo url('tiaojian/szdw'); ?>">师资队伍</a></dd>
              <dd ><a href="<?php echo url('tiaojian/sjjx'); ?>">实践教学</a></dd>
              <dd><a href="<?php echo url('tiaojian/bxbz'); ?>">办学保障</a></dd>
              <dd class="curr"><a href="<?php echo url('tiaojian/xszl'); ?>">学生质量</a></dd>
		 
          </dl>
        </div>
        <div class="col-md-9  wow fadeInRight" data-wow-delay="0.2s">
         <div class="bxyf"><i>专业设置</i><ul><li>您当前的位置：</li><li><a href="index2.html">首页</a></li><li>>></li><li><a href="">申报条件</a></li><li>>></li><li><a href="">培养模式</a></li></ul></div>
         <div class="bxyg">
            <div class="zyjsbox">
           		根据学院组织的治安学毕业生的跟踪调查，先后调查了苏南、苏中和苏北的八个市公安局及其相关分县局，毕业生用人单位普遍认为我院培养的治安学专业学生：政治素质好，大局意识、服从意识、奉献意识强，法律和公安业务基础知识扎实，业务上手快，独立工作能力强。连续多年治安学专业毕业生就业率达100%，参加司法资格考试的通过率稳定在30%以上。35年来，治安学专业已为我省以及浙江、山东、福建、安徽、上海等省市公安机关培养治安管理人才15000多人，其中80%的毕业生已经成为各级公安机关的领导或业务骨干，毕业生受到用人单位的好评。
            </div>
         </div>
        </div>
    </div>
