<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:57:"D:\lp\WWW\jingguan/application/index\view\neiye\jxzy.html";i:1547284873;s:60:"D:\lp\WWW\jingguan/application/index\view\public\footer.html";i:1547171540;}*/ ?>
  ...
  <div class="nav-wrapper">
    ...
    <div class="nav" id="nav">
      <ul class="nav_lf">
          ...
          <li><a class="bxyact" href="<?php echo url('neiye/jxzy'); ?>">教学条件与投入</a></li>
      </ul>
      <ul class="nav_rt">
    ...
    <div class="row">
        <div class="col-md-3  wow fadeInLeft" data-wow-delay="0.2s">
          <dl class="hidden-xs bxye">
           <dt>教学条件与投入</dt>
           <dd class="curr"><a href="<?php echo url('neiye/jxzy'); ?>">教学资源</a></dd>
           <dd><a href="<?php echo url('neiye/jfbz'); ?>">经费保障</a></dd>
          </dl>
                ...
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#accordion"
                           href="#collapseOne">教学条件与投入<i class="glyphicon glyphicon-chevron-down"></i></a>
                    </h4>
                </div>
                <div id="collapseOne" class="panel-collapse collapse">
                    <div class="panel-body">
                        <ul>
                            <li class="cur"><a href="<?php echo url('neiye/jxzy'); ?>">教学资源</a></li>
                            <li><a href="<?php echo url('neiye/jfbz'); ?>">经费保障</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-9  wow fadeInRight" data-wow-delay="0.2s">
         <div class="bxyf"><i>教学资源</i><ul><li>您当前的位置：</li><li><a href="index2.html">首页</a></li><li>>></li><li><a href="">教学条件与投入</a></li><li>>></li><li><a href="">教学资源</a></li></ul></div>
         <div class="bxyg">
