<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"D:\lp\WWW\jingguan\public/../application/index\view\neiye\sqs1.html";i:1547204197;s:70:"D:\lp\WWW\jingguan\public/../application/index\view\public\footer.html";i:1547171540;}*/ ?>
...
<header class="header">
    ...
    <div class="nav-wrapper">
        <div class="logo"><a href="index2.html"><img src="__STATIC__/images/logo.png" alt="" style="width:100%;max-width:100%;width:auto\9;-ms-interpolation-mode: bicubic;"></a></div>
        <div class="nav" id="nav">
            <ul class="nav_lf">
                <li><a class="bxyact" href="download.html">申报材料</a></li>
                <li><a href="neiye-jianshe1.html">专业建设与人才培养</a></li>
                <li><a href="neiye-shizi1.html">师资结构与素质</a></li>
                <li><a href="neiye-jiaoxue1.html">教学条件与投入</a></li>
            </ul>
            <ul class="nav_rt">
                <li><a href="neiye-kecheng1.html">课程建设与改革</a></li>
                <li><a href="neiye-zhiliang1.html">教育质量与服务能力</a></li>
                <li><a href="neiye-guanli1.html">教学管理与优势特色</a></li>
            </ul>
        </div>
    </div>
    ...
    <section class="mobile">
        ...
        <div class="mobile-inner-nav">
            <ul>
                <li><a href="download.html">申报材料</a></li>
                <li><a href="neiye-jianshe1.html">专业建设与人才培养</a></li>
                <li><a href="neiye-shizi1.html">师资结构与素质</a></li>
                <li><a href="neiye-jiaoxue1.html">教学条件与投入</a></li>
                <li><a href="neiye-kecheng1.html">课程建设与改革</a></li>
        ...
        <div class="row">
            ...
            <div class="col-md-3  wow fadeInLeft" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInLeft;">
                ...
                <dl class="hidden-xs bxye">
                    ...
                    <dd class="curr">
                        <a href="download.html">申请书</a>
                    </dd>
                    <dd>
                        <a href="download1.html">佐证材料</a>
                    </dd>
                </dl>
