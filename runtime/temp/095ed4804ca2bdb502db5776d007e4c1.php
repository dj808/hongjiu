<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"D:\lp\WWW\jingguan\public/../application/index\view\neiye\kcgg.html";i:1547193241;s:70:"D:\lp\WWW\jingguan\public/../application/index\view\public\footer.html";i:1547171540;}*/ ?>
    ...
    <div class="row">
        <div class="col-md-3  wow fadeInLeft" data-wow-delay="0.2s">
          <dl class="bxye">
		   ...
		   <dd class="curr"><a href="<?php echo url('neiye/kcgg'); ?>">课程改革</a></dd>
		   
          </dl>
        </div>
        <div class="col-md-9  wow fadeInRight" data-wow-delay="0.2s">
         <div class="bxyf"><i>专业设置</i><ul><li>您当前的位置：</li><li><a href="<?php echo url('neiye/index'); ?>">首页</a></li><li>>></li><li><a href="">课程建设与改革</a></li><li>>></li><li><a href="">课程改革</a></li></ul></div>
         <div class="bxyg">
