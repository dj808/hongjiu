<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:57:"D:\lp\WWW\jingguan/application/index\view\neiye\jxgl.html";i:1547285277;s:60:"D:\lp\WWW\jingguan/application/index\view\public\footer.html";i:1547171540;}*/ ?>
  ...
  <div class="nav-wrapper">
    ...
    <div class="nav" id="nav">
      ...
      <ul class="nav_rt">
          ...
          <li><a  class="bxyact" href="<?php echo url('neiye/jxgl'); ?>">教学管理与优势特色</a></li>
      </ul>
    </div>
  </div>
    ...
    <div class="row">
        <div class="col-md-3  wow fadeInLeft" data-wow-delay="0.2s">
          <dl class="hidden-xs bxye">
           <dt>教学管理与优势特色</dt>
           <dd class="curr"><a href="<?php echo url('neiye/jxgl'); ?>">教学管理</a></dd>
           <dd><a href="<?php echo url('neiye/zyys'); ?>">专业优势与特色</a></dd>
            ...
            <div class="hidden-sm hidden-md hidden-lg xiala-box panel panel-default">
                ...
                <div id="collapseOne" class="panel-collapse collapse">
                    <div class="panel-body">
                        <ul>
                            <li class="curr"><a href="<?php echo url('neiye/jxgl'); ?>">教学管理</a></li>
                            <li><a href="<?php echo url('neiye/zyys'); ?>">专业优势与特色</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-9  wow fadeInRight" data-wow-delay="0.2s">
         <div class="bxyf"><i>教学管理</i><ul><li>您当前的位置：</li><li><a href="index2.html">首页</a></li><li>>></li><li><a href="">教学管理与优势特色</a></li><li>>></li><li><a href="">教学管理</a></li></ul></div>
         <div class="bxyg">
            <div class="zyjsbox">
